    ...
    <section className={`note-composer ${speech.listening ? 'is-listening' : ''}`} aria-label="Add a note">
      ...
      <div className="note-composer-footer">
        <span className="speech-status" aria-live="polite">
          {speech.listening ? <><i /> Listening… speak naturally.</> : speech.error ?? (speech.supported ? 'Voice stays in your browser — nothing is stored here.' : 'Dictation is not supported in this browser.')}
        </span>
