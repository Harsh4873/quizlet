  ...
  'pda-ends': (
    <Machine
      ...
      nodes={[
        ...
        { id: 'q1', x: 180, y: 45, label: 'q1' },
        { id: 'q3', x: 320, y: 45, label: 'q3', accept: true },
        { id: 'q2', x: 180, y: 155, label: 'q2' },
        { id: 'q4', x: 320, y: 155, label: 'q4', accept: true },
      ]}
      links={[
      ...
      loops={[
        { id: 'q1', label: `0/1, ${e}`, side: 'above' },
        { id: 'q2', label: `0/1, ${e}`, side: 'below' },
      ]}
    />
  ),
  'pda-odd': (
